...
begin
    ...
    begin
        ...
        ParamByName('Birthday').Value := FormatDatetime('yyyy-mm-dd', FBirthday);
...
//
        ...
        ParamByName('CardSignDate').Value := FormatDatetime('yyyy-mm-dd', FCardSignDate);
        ...
        ParamByName('MoveTime').Value := FormatDatetime('yyyy-mm-dd', FMoveTime);
...
function TPerson.getRecCount: integer;
var
    adoQuery: TAdoQuery;
const
    sqlStr: widestring = 'SELECT Count(id) from Records ';
begin
    adoQuery := TAdoQuery.Create(nil);
    adoQuery.Connection := dm.ac;
    adoQuery.SQL.Clear;
